...
async function main() {
  ...
  await prisma.mail.createMany({
    data: [
      { mailID: 1001, recepientName: "Alice Johnson",     recepientAddressID: 26, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 0.5,   price: 65.0, mailstatus: MailStatus.IN_TRANSIT },
      { mailID: 1002, recepientName: "Bob Smith",          recepientAddressID: 27, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 13,    price: 110.0, mailstatus: MailStatus.IN_TRANSIT },
      { mailID: 1003, recepientName: "Charlie Brown",     recepientAddressID: 28, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 56,    price: 120,   mailstatus: MailStatus.IN_TRANSIT },
      { mailID: 1004, recepientName: "David Wilson",      recepientAddressID: 26, postalCode: "10640", transactionID: 4, mailType: MailType.NORMAL_MAIL, weight: 1.5,   price: 7.0,   mailstatus: MailStatus.IN_TRANSIT },
      ...
      { mailID: 1009, recepientName: "Irene Thomas",      recepientAddressID: 52, postalCode: "10640", transactionID: 4, mailType: MailType.COURIER,      weight: 92.0,  price: 5.2,   mailstatus: MailStatus.IN_TRANSIT },
      { mailID: 1010, recepientName: "Jack White",       recepientAddressID: 32, postalCode: "10640", transactionID: 4, mailType: MailType.COURIER,      weight: 200,   price: 92.0,  mailstatus: MailStatus.IN_TRANSIT },
      ...
      { mailID: 1013, recepientName: "Mia Robinson",     recepientAddressID: 35, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 34,    price: 82.0,  mailstatus: MailStatus.IN_TRANSIT },
      { mailID: 1014, recepientName: "Noah Jackson",     recepientAddressID: 52, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 68,    price: 45.0,  mailstatus: MailStatus.IN_TRANSIT },
      { mailID: 1015, recepientName: "Bob Williams",     recepientAddressID: 26, postalCode: "10640", transactionID: 4, mailType: MailType.NORMAL_MAIL, weight: 20,    price: 30.0,  mailstatus: MailStatus.IN_TRANSIT },
      { mailID: 1016, recepientName: "Bob Williams",     recepientAddressID: 27, postalCode: "10640", transactionID: 4, mailType: MailType.NORMAL_MAIL, weight: 20,    price: 30.0,  mailstatus: MailStatus.IN_TRANSIT },
      { mailID: 1017, recepientName: "Bob Williams",     recepientAddressID: 28, postalCode: "10640", transactionID: 4, mailType: MailType.COURIER,      weight: 2000,  price: 400.0, mailstatus: MailStatus.IN_TRANSIT },
      { mailID: 1018, recepientName: "Bob Williams",     recepientAddressID: 29, postalCode: "10640", transactionID: 4, mailType: MailType.NORMAL_MAIL, weight: 80,    price: 100.0, mailstatus: MailStatus.IN_TRANSIT },
      { mailID: 1019, recepientName: "Bob Williams",     recepientAddressID: 30, postalCode: "10640", transactionID: 3, mailType: MailType.REGISTERED_MAIL, weight: 82, price: 35.0,  mailstatus: MailStatus.IN_TRANSIT },
      { mailID: 1020, recepientName: "Bob Williams",     recepientAddressID: 31, postalCode: "10640", transactionID: 4, mailType: MailType.REGISTERED_MAIL, weight: 50,   price: 100.0, mailstatus: MailStatus.DELIVERED },
      { mailID: 1021, recepientName: "Bob Williams",     recepientAddressID: 32, postalCode: "10640", transactionID: 4, mailType: MailType.REGISTERED_MAIL, weight: 300.0, price: 1000.0, mailstatus: MailStatus.IN_TRANSIT },
      ...
      { mailID: 1027, recepientName: "Bob Williams",     recepientAddressID: 32, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 200,   price: 92.0,  mailstatus: MailStatus.IN_TRANSIT },
  ...
  await prisma.leave.createMany({
    data: [
      ...
      { employeeID: "0002", leaveType: LeaveType.FULL_DAY, startDate: new Date("2024-09-10"), endDate: new Date("2024-09-11"), description: "Annual Leave", RequestStatus: RequestStatus.PENDING, requstedDate: new Date("2024-09-03"), },

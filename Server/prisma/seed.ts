...
async function main() {
  ...
  await prisma.bundle.createMany({
    data: [
      { bundleID: 78, destPostalCode: "10640", currentPostCode: "10640", bundleStatus: BundleStatus.DISTRIBUTED, route: ["00100", "11000", "10640"] },
      { bundleID: 79, destPostalCode: "10640", currentPostCode: "10640", bundleStatus: BundleStatus.DISTRIBUTED, route: ["80280", "80000", "10640"] },
      { bundleID: 41, destPostalCode: "11000", currentPostCode: "10640", bundleStatus: BundleStatus.CREATED, route: ["10640", "80000", "80280"] },
      { bundleID: 20, destPostalCode: "10640", currentPostCode: "10640", bundleStatus: BundleStatus.ARRIVED, route: ["00100", "10640"] },
      ...
      { bundleID: 24, destPostalCode: "10370", currentPostCode: "10640", bundleStatus: BundleStatus.CREATED, route: ["10640", "10370"] },
      { bundleID: 25, destPostalCode: "20850", currentPostCode: "10640", bundleStatus: BundleStatus.CREATED, route: ["10640", "20000", "20850"] },
      { bundleID: 27, destPostalCode: "10120", currentPostCode: "10640", bundleStatus: BundleStatus.CREATED, route: ["10640", "10120"] },
      { bundleID: 28, destPostalCode: "10250", currentPostCode: "10640", bundleStatus: BundleStatus.ARRIVED, route: ["00100",  "10250"] },
  ...
  await prisma.mail.createMany({
    data: [
      { mailID: 1001, recepientName: "Alice Johnson",     recepientAddressID: 54, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 0.5,   price: 65.0, mailstatus: MailStatus.IN_TRANSIT, bundleID:78 },
      { mailID: 1002, recepientName: "Bob Smith",          recepientAddressID: 55, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 13,    price: 110.0, mailstatus: MailStatus.IN_TRANSIT, bundleID:78  },
      { mailID: 1003, recepientName: "Charlie Brown",     recepientAddressID: 56, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 56,    price: 120,   mailstatus: MailStatus.IN_TRANSIT, bundleID:78 },
      { mailID: 1004, recepientName: "David Wilson",      recepientAddressID: 46, postalCode: "10640", transactionID: 4, mailType: MailType.NORMAL_MAIL, weight: 1.5,   price: 7.0,   mailstatus: MailStatus.IN_TRANSIT, bundleID:24 },
      { mailID: 1005, recepientName: "Emma Davis",        recepientAddressID: 27, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 200,   price: 120.0, mailstatus: MailStatus.DELIVERED },
      { mailID: 1006, recepientName: "Frank Miller",      recepientAddressID: 28, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 100,   price: 45.0,  mailstatus: MailStatus.DELIVERED },
      { mailID: 1007, recepientName: "Grace Lee",         recepientAddressID: 53, postalCode: "10640", transactionID: 4, mailType: MailType.NORMAL_MAIL, weight: 1.1,   price: 6.5,   mailstatus: MailStatus.DELIVERED },
      { mailID: 1008, recepientName: "Henry Taylor",      recepientAddressID: 54, postalCode: "10640", transactionID: 4, mailType: MailType.NORMAL_MAIL, weight: 78,    price: 65.0,  mailstatus: MailStatus.DELIVERED },
      { mailID: 1009, recepientName: "Irene Thomas",      recepientAddressID: 43, postalCode: "10640", transactionID: 4, mailType: MailType.COURIER,      weight: 92.0,  price: 5.2,   mailstatus: MailStatus.IN_TRANSIT, bundleID:25},
      { mailID: 1010, recepientName: "Jack White",       recepientAddressID: 43, postalCode: "10640", transactionID: 4, mailType: MailType.COURIER,      weight: 200,   price: 92.0,  mailstatus: MailStatus.IN_TRANSIT, bundleID:25 },
      { mailID: 1011, recepientName: "Kathy Harris",     recepientAddressID: 33, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 56,    price: 65.0,  mailstatus: MailStatus.IN_TRANSIT },
      { mailID: 1012, recepientName: "Liam Clark",       recepientAddressID: 34, postalCode: "10640", transactionID: 4, mailType: MailType.REGISTERED_MAIL, weight: 40,   price: 57.0,  mailstatus: MailStatus.IN_TRANSIT },
      { mailID: 1013, recepientName: "Mia Robinson",     recepientAddressID: 48, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 34,    price: 82.0,  mailstatus: MailStatus.IN_TRANSIT, bundleID: 27 },
      { mailID: 1014, recepientName: "Noah Jackson",     recepientAddressID: 48, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 68,    price: 45.0,  mailstatus: MailStatus.IN_TRANSIT, bundleID: 27  },
      { mailID: 1015, recepientName: "Bob Williams",     recepientAddressID: 48, postalCode: "10640", transactionID: 4, mailType: MailType.NORMAL_MAIL, weight: 20,    price: 30.0,  mailstatus: MailStatus.IN_TRANSIT, bundleID: 27  },
      { mailID: 1016, recepientName: "Bob Williams",     recepientAddressID: 48, postalCode: "10640", transactionID: 4, mailType: MailType.NORMAL_MAIL, weight: 20,    price: 30.0,  mailstatus: MailStatus.IN_TRANSIT, bundleID: 27  },
      { mailID: 1017, recepientName: "Bob Williams",     recepientAddressID: 49, postalCode: "10640", transactionID: 4, mailType: MailType.COURIER,      weight: 2000,  price: 400.0, mailstatus: MailStatus.IN_TRANSIT,bundleID: 41 },
      { mailID: 1018, recepientName: "Bob Williams",     recepientAddressID: 49, postalCode: "10640", transactionID: 4, mailType: MailType.NORMAL_MAIL, weight: 80,    price: 100.0, mailstatus: MailStatus.IN_TRANSIT,bundleID: 41 },
      { mailID: 1019, recepientName: "Bob Williams",     recepientAddressID: 49, postalCode: "10640", transactionID: 3, mailType: MailType.REGISTERED_MAIL, weight: 82, price: 35.0,  mailstatus: MailStatus.IN_TRANSIT ,bundleID: 41},
      { mailID: 1020, recepientName: "Bob Williams",     recepientAddressID: 49, postalCode: "10640", transactionID: 4, mailType: MailType.REGISTERED_MAIL, weight: 50,   price: 100.0, mailstatus: MailStatus.DELIVERED, bundleID: 41 },
      { mailID: 1021, recepientName: "Bob Williams",     recepientAddressID: 26, postalCode: "10640", transactionID: 4, mailType: MailType.REGISTERED_MAIL, weight: 300.0, price: 1000.0, mailstatus: MailStatus.IN_TRANSIT, bundleID: 79 },
      { mailID: 1022, recepientName: "Bob Williams",     recepientAddressID: 33, postalCode: "10640", transactionID: 4, mailType: MailType.REGISTERED_MAIL, weight: 400,   price: 300.0, mailstatus: MailStatus.DELIVERED },
      { mailID: 1023, recepientName: "Bob Williams",     recepientAddressID: 34, postalCode: "10640", transactionID: 3, mailType: MailType.COURIER,      weight: 2000,  price: 1000.0, mailstatus: MailStatus.DELIVERED },
      { mailID: 1024, recepientName: "Bob Williams",     recepientAddressID: 35, postalCode: "10640", transactionID: 4, mailType: MailType.COURIER,      weight: 800,   price: 950.0, mailstatus: MailStatus.DELIVERED },
      { mailID: 1025, recepientName: "Bob Williams",     recepientAddressID: 29, postalCode: "10640", transactionID: 4, mailType: MailType.NORMAL_MAIL, weight: 45,   price: 120.0, mailstatus: MailStatus.DELIVERED },
      { mailID: 1026, recepientName: "Bob Williams",     recepientAddressID: 35, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 1.2, price: 6.0,   mailstatus: MailStatus.DELIVERED },
      { mailID: 1027, recepientName: "Bob Williams",     recepientAddressID: 36, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 200,   price: 92.0,  mailstatus: MailStatus.IN_TRANSIT, bundleID: 78, deliveryAttempts: 2 },
      { mailID: 1029, recepientName: "Bob Williams",     recepientAddressID: 29, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 200,   price: 92.0,  mailstatus: MailStatus.IN_TRANSIT, bundleID: 78, deliveryAttempts: 2 },
      { mailID: 1028, recepientName: "Bob Williams",     recepientAddressID: 36, postalCode: "10640", transactionID: 3, mailType: MailType.NORMAL_MAIL, weight: 1.2, price: 6.0, mailstatus: MailStatus.DELIVERED,
      },
    ],
  });
